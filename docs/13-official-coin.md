...
- **withdrawn for good on 13 September 2026 and burned.** By then the two positions (ids 2135484 and 2139558) were almost all coin: 151,499,499 TICKR and 247 FUN. The treasury wallet handed them to the deployer, which burned the positions, sent every TICKR to the dead address, redeemed the FUN for 247 USDG and put the dollars into the HOLY treasury, where they are split like every other dollar it collects (`script/WithdrawV1.s.sol`, transaction `0xbb2612ac381312f9770caf969cb86bc2d0fb7c31461fb0dda55fa7a20af0c1e6`). The treasury wallet holds no TICKR position any more; 176,151,988 TICKR sit at the dead address.
