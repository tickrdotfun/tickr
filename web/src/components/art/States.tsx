import { FONT, HUES, INK, PAPER, RADIUS, STROKE, shade } from "./system";
  ...
  return (
    <svg viewBox="0 0 240 240" className={className} role="img" aria-label="an empty tile rack">
      ...
      <g stroke={INK} strokeWidth={STROKE} strokeLinejoin="round" strokeLinecap="round">
        ...
        <rect x="44" y="86" width="46" height="52" rx={RADIUS} fill="#0B1F14" />
        <rect x="98" y="86" width="46" height="52" rx={RADIUS} fill="#0B1F14" />
        <rect x="152" y="86" width="46" height="52" rx={RADIUS} fill="#0B1F14" />
