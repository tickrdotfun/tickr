...
const FIXED: [string, string, string?][] = [
  ...
  ["of that, to the creator", "60%", "70% on any pair that is not an invented ticker, where there is no club"],
  ["to the ticker club", "10%", "the other coins under the same ticker, by 30-day pool volume"],
  ["to the protocol", "30%", "3,000 bps, on every pair"],
  ["creator tax ceiling", "2%", "the most a creator can set. all of it is the creator's"],
